...
public class bandbajabaraat extends Activity{

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.bandbajabarat);	}
	...
	{
		String str = "Band Baja Baraat";
		Intent it = new Intent("android.intent.action.SETNOTIFICATION");
		it.putExtra("event", str);
		it.putExtra("address", "android.intent.action.BANDBAJABARAAT");
		startActivity(it);
	}
