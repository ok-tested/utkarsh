...
public class heats200girls extends Activity{

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.heats200mtrgirls);
	}
	...
	{
		String str = "200 mtr Heats(Boys) ";
		Intent it = new Intent("android.intent.action.SETNOTIFICATION");
		it.putExtra("event", str);
		it.putExtra("address", "android.intent.action.HEATSTWOHUNDREDBOYS)");
		startActivity(it);
	}
