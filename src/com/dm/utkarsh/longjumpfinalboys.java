...
public class longjumpfinalboys extends Activity{

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.longjumpfinalboys);
	}
	...
	{
		String str = "Long Jumping (Boys)";
		Intent it = new Intent("android.intent.action.SETNOTIFICATION");
		it.putExtra("event", str);
		it.putExtra("address", "android.intent.action.LONGJUMPINGBOYS");
		startActivity(it);
	}
