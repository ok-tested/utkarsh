...
public class picturaecavea extends Activity{

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.picturecavea);	}
	...
	{
		String str = "PicturaeCavea";
		Intent it = new Intent("android.intent.action.SETNOTIFICATION");
		it.putExtra("event", str);
		it.putExtra("address", "android.intent.action.PICTURAECAVEA");
		startActivity(it);
	}
