...
public class shamsheeretaqreer extends Activity{

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
  	  setContentView(R.layout.shamsheeretaqreer);
}
	...
	{
		String str = "ShamsheerETaqreer";
		Intent it = new Intent("android.intent.action.SETNOTIFICATION");
		it.putExtra("event", str);
		it.putExtra("address", "android.intent.action.SHAMSHEERETAQREER");
		startActivity(it);
	}
