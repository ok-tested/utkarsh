...
public class triplejumpfinalgirls extends Activity{

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.triplejumpfinalgirls);
	}
	...
	{
		String str = "Triple Jumps(Girls)";
		Intent it = new Intent("android.intent.action.SETNOTIFICATION");
		it.putExtra("event", str);
		it.putExtra("address", "android.intent.action.TRIPLEJUMPGIRLS");
		startActivity(it);
	}
